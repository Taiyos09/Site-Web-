...
const updateGalleryImage = (
  ...
  updated[eventIndex].gallery[imageIndex] = value

  setEventsData(updated)
}

const addGalleryImage = (eventIndex: number) => {
  const updated = [...eventsData]

  updated[eventIndex].gallery.push(
    "/images/photo.jpg"
  )
...
<section className="rounded-[36px] border border-[#e7ded2] bg-white/80 p-10 shadow-xl backdrop-blur">
  ...
  <div className="mb-10 flex items-center justify-between">
    ...
    <button
      onClick={addEvent}
      className="rounded-2xl bg-[#c89b5f] px-6 py-3 font-semibold text-white"
    >
        ...
        <div className="mt-10">
          ...
          <div className="mb-6 flex items-center justify-between">
            ...
            <button
              ...
              className="rounded-2xl bg-[#2f241d] px-5 py-3 text-white"
            >
              Ajouter une photo
            </button>
          </div>
